...
//LCD pins			PORT, PIN
#define LCD_D4        D, 5 // Arduino 5
#define LCD_D5        D, 4 // Arduino 4
#define LCD_D6        D, 3 // Arduino 3
#define LCD_D7        D, 6 // Arduino 6
#define LCD_RS        B, 1 // Arduino 9
#define LCD_RW        D, 7 // Arduino 7
#define LCD_EN        B, 0 // Arduino 8
//----------------------------------------------//
#endif
